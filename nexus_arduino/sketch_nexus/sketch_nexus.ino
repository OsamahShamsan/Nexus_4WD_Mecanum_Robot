...
void loop() {
  Omni.wheelULSetSpeedMMPS(100);
  Omni.wheelLLSetSpeedMMPS(200);
  Omni.wheelLRSetSpeedMMPS(500, DIR_BACKOFF);      // in the opposite direction
  Omni.wheelURSetSpeedMMPS(300, DIR_BACKOFF);      // in the opposite direction
